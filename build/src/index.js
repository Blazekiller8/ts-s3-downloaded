 ...
 */
import { S3Client, S3ServiceException, ListObjectsV2Command, GetObjectCommand, } from '@aws-sdk/client-s3';
...
(async () => {
    ...
    try {
        ...
        var listResponse = await client.send(listCommand);
    ...
    if (listResponse.Contents) {
        for (const object of listResponse.Contents) {
            ...
            try {
                ...
                getResponse.Body && ((_a = getResponse.Body) === null || _a === void 0 ? void 0 : _a.pipe(fileStream));
